...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			...
			<div class="navbar-nav">
				<a class="nav-item nav-link" href="exemplo02.php">Exemplo02</a>
			</div>			
			<div class="navbar-nav">
				<a class="nav-item nav-link" href="exemplo03.php">Exemplo03</a>
			</div>
			<div class="navbar-nav">
				<a class="nav-item nav-link active" href="exemplo04.php">Exemplo04</a>
			</div>										
		</div>
	</nav>
	<br>
	<div class="container">	
		<h1 id="titulo">Exemplo 04 - Gastos por mês agrupados por tipo [Banco de Dados]<h1>
	...
	<script type="text/javascript" src="js/exemplo04.js"></script>	
</body>
